...
!-----------------------------------------------------------------
	function background_opacity(T, Pe, PH, PHminus, PHplus, PH2, PH2plus, lambda_in)
	real(kind=8) :: background_opacity, T, Pe, PH, PHminus, PHplus, PH2, PH2plus, lambda_in

...
!!!-------------------------------------------
    SUBROUTINE LOG_INIT
      ...
      CALL LOGW_CHAR(30,'TEST version 1.00: Started !!')
      CALL LOGW_CHAR(60,'==========================================================')
      CALL LOGW_CHAR(60,'This is a Free Program originally developed by J M Borrero')
      CALL LOGW_CHAR(60,'----------------------------------------------------------')
...
!!!-------------------------------------------
!!!-------------------------------------------
    SUBROUTINE LOGW_CHAR(LEN,MESS)
      CHARACTER(LEN)           :: MESS
      WRITE(UNIT=LOGUNIT,FMT='(A)') MESS
    END SUBROUTINE LOGW_CHAR
!!!-------------------------------------------
!!!-------------------------------------------
    SUBROUTINE LOGW_CHAR_REAL(LEN,MESS,REA)
      CHARACTER(LEN)           :: MESS
      REAL(DP)                 :: REA
...
!!!-------------------------------------------
!!!-------------------------------------------
    SUBROUTINE LOGW_CHAR_INT (LEN,MESS,INT)
      CHARACTER(LEN)           :: MESS
      INTEGER                  :: INT
...
!!!-------------------------------------------
!!!-------------------------------------------
    SUBROUTINE LOGW_CHAR_CHAR(LEN1,MESS1,LEN2,MESS2)
      CHARACTER(LEN1)           :: MESS1
      CHARACTER(LEN2)           :: MESS2
...
!!!-------------------------------------------
    SUBROUTINE LOGW_INV_DETAILS
      ...
      ENDDO
      CALL LOGW_CHAR_INT(30,'Total Num of Free Parameters: ',NF)
      CALL LOGW_CHAR(60,'----------------------------------------------------------')
...
!!!-------------------------------------------
    SUBROUTINE LOGW_SUMMARY(TIME,N10,N25,MEANC)
      ...
      REAL(4)         :: TIME
      CALL LOGW_CHAR(60,'----------------------------------------------------------')
      CALL LOGW_CHAR_REAL(21,'Time [sec] employed: ',DBLE(TIME))
      ...
      !ENDIF
      CALL LOGW_CHAR(60,'==========================================================')
      CALL LOGW_CHAR(31,'TEST version 1.00: Finished !!')
